...
declare type ifOptions = Partial<
  Is & IsGreaterThan & IsLessThan & IsGreaterThanOrEqualTo & IsLessThanOrEqualTo & IsBetween
>;
...
declare type NodeExtended = { [P in keyof NodeExtensions]: ReplaceReturnType<NodeExtensions[P], IvNode> };
