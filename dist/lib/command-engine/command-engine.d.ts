export declare class IvCommandEngine implements CommandEngine.Class {
    ...
    private runners;
    constructor(settings: CommandEngine.ctor['settings'], nodes: CommandEngine.ctor['nodes'], commandRunnerClass: CommandEngine.ctor['commandRunnerClass'], variables: CommandEngine.ctor['variables']);
    registerTargetFunction(factory: CommandEngine.TargetFunctionFactory): void;
