...
declare class Definitions {
  ...
  addZoneInput: () => import('../lib/plugins/dom-commands/zones/add-zone').AddZoneSettings;
  addZoneCommand: () => ICommand.AddZone;
  removeZoneCommand: () => ICommand.RemoveZone;
  ...
  node: () => BaseNode;
  targetFunctionFactoryInput: () => CommandEngine.InitializerState;
